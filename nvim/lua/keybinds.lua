...
-- Some functionality that will be binded
Keybinds.switch_theme = function ()
    -- Some stuff here
end
...
wk.register({
    ...
    name = 'Extrenal menus',
        ...
        t = { ':NvimTreeToggle<CR>',                'File tree menu'            },
    ...
    v = { name = 'Visuals',
        ...
        t = { function() require('onedark').toggle() end, 'Toggle theme', },
