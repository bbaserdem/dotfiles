...
iso_publisher="Batuhan Başerdem"
iso_application="Arch Linux Live CD - Personalized"
...
make_remove_offender() {
    arch-chroot ${work_dir}/x86_64/airootfs/ pacman -R nano vi
}
...
make_efi() {
    ...
    [ -e /etc/sbkeys/sbsign.sh ] && /etc/sbkeys/sbsign.sh \
        ${work_dir}/x86_64/airootfs/usr/share/efitools/efi/PreLoader.efi \
        ${work_dir}/x86_64/airootfs/usr/share/efitools/efi/HashTool.efi
    cp ${work_dir}/x86_64/airootfs/usr/share/efitools/efi/PreLoader.efi ${work_dir}/iso/EFI/boot/bootx64.efi
    cp ${work_dir}/x86_64/airootfs/usr/share/efitools/efi/HashTool.efi ${work_dir}/iso/EFI/boot/

    [ -e /etc/sbkeys/sbsign.sh ] && /etc/sbkeys/sbsign.sh \
        ${work_dir}/x86_64/airootfs/usr/lib/systemd/boot/efi/systemd-bootx64.efi
    ...
    [ -e /etc/sbkeys/sbsign.sh ] && /etc/sbkeys/sbsign.sh \
        ${work_dir}/iso/EFI/shellx64_v2.efi ${work_dir}/iso/EFI/shellx64_v1.efi
...
make_efiboot() {
    ...
    [ -e /etc/sbkeys/sbsign.sh ] && /etc/sbkeys/sbsign.sh \
        ${work_dir}/iso/${install_dir}/boot/x86_64/vmlinuz
